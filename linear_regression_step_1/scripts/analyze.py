...
if __name__ == '__main__':
    ...
    # Fixed bug by specifying the x and y columns
    best = run_analysis(data_path, x_col='enginesize', y_col='price',)
    # Issue where tuple was expected but dict was returned was fixed by returning dict in headless mode
